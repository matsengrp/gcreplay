...
# args="--random-seed 23 --paired-loci --no-pairing-info"
# args="$args --species mouse --airr-output --extra-annotation-columns seqs_aa:n_mutations"
# args="$args --no-insertions-or-deletions --leave-default-germline"
# args="$args --initial-germline-dir $GERMLINE_DIR"

# mkdir -p $OUTPUT_DIR/engrd
# ./bin/partis annotate $args --infname $INPUT_FASTA --paired-outdir $OUTPUT_DIR/engrd
